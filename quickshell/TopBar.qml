...
Variants {
    ...
    delegate: Component {
	    ...
	    Process {
            ...
            Process {
                id: settingsReader
                command: ["bash", "-c", "cat ~/.config/mango/settings.json 2>/dev/null || echo '{}'"]
                running: true
                stdout: StdioCollector {
                    onStreamFinished: {
                        try {
            ...
            Process {
                id: settingsWatcher
                command: ["bash", "-c", "while [ ! -f ~/.config/mango/settings.json ]; do sleep 1; done; inotifywait -qq -e modify,close_write ~/.config/mango/settings.json"]
                running: true
                stdout: StdioCollector {
                    onStreamFinished: {
            ...
            Process {
                id: wsDaemon
                command: ["bash", "-c", "~/.local/share/mango/scripts/workspaces.sh"]
                running: true
            }
            ...
            Item {
                    ...
                    Row {
                        ...
                        Rectangle {
                            ...
                            MouseArea {
                                ...
                                anchors.fill: parent
                                hoverEnabled: true
                                onClicked: Quickshell.execDetached(["bash", "-c", "~/.local/share/mango/scripts/qs_manager.sh toggle guide"])
                            }
                        }
                        ...
                        Rectangle {
                            ...
                            MouseArea {
                                ...
                                anchors.fill: parent
                                hoverEnabled: true
                                onClicked: Quickshell.execDetached(["bash", "-c", "~/.local/share/mango/scripts/qs_manager.sh toggle applauncher"])
                            }
                        }
                        ...
                        Rectangle {
                            ...
                            MouseArea {
                                ...
                                anchors.fill: parent
                                hoverEnabled: true
                                onClicked: Quickshell.execDetached(["bash", "-c", "~/.local/share/mango/scripts/qs_manager.sh toggle settings"])
                            }
                        }
                        ...
                        Rectangle {
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    ...
                                    Quickshell.execDetached(["bash", "-c", "~/.local/share/mango/scripts/qs_manager.sh toggle updater"]);
                                }
                            }
                        }
                    }
                        ...
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                MouseArea {
                                    ...
                                    hoverEnabled: true
                                    anchors.fill: parent
                                    onClicked: Quickshell.execDetached(["bash", "-c", "~/.local/share/mango/scripts/qs_manager.sh " + wsName])
                                }
                            }
                        }
                    }
                    ...
                    Item {
                        ...
                        Row {
                            ...
                            MouseArea {
                                ...
                                hoverEnabled: true
                                onClicked: Quickshell.execDetached(["bash", "-c", "~/.local/share/mango/scripts/qs_manager.sh toggle music"])
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        anchors.fill: parent
                        hoverEnabled: true
                        onClicked: Quickshell.execDetached(["bash", "-c", "~/.local/share/mango/scripts/qs_manager.sh toggle calendar"])
                    }
                    ...
                    Rectangle {
                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                MouseArea { id: kbMouse; anchors.fill: parent; hoverEnabled: true; onClicked: Quickshell.execDetached(["bash", "-c", "~/.local/share/mango/scripts/mango/keyboard.sh switch"]) }
                            }
                            ...
                            Rectangle {
                                ...
                                MouseArea { id: wifiMouse; hoverEnabled: true; anchors.fill: parent; onClicked: Quickshell.execDetached(["bash", "-c", "~/.local/share/mango/scripts/qs_manager.sh toggle network wifi"]) }
                            }
                            ...
                            Rectangle {
                                ...
                                MouseArea { id: btMouse; hoverEnabled: true; anchors.fill: parent; onClicked: Quickshell.execDetached(["bash", "-c", "~/.local/share/mango/scripts/qs_manager.sh toggle network bt"]) }
                            }
                            ...
                            Rectangle {
                                ...
                                MouseArea { id: volMouse; hoverEnabled: true; anchors.fill: parent; onClicked: Quickshell.execDetached(["bash", "-c", "~/.local/share/mango/scripts/qs_manager.sh toggle volume"]) }
                            }
                            ...
                            Rectangle {
                                ...
                                MouseArea { id: batMouse; hoverEnabled: true; anchors.fill: parent; onClicked: Quickshell.execDetached(["bash", "-c", "~/.local/share/mango/scripts/qs_manager.sh toggle battery"]) }
                            }                       
                 }
            }
            Rectangle {
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                ...
                                Quickshell.execDetached(["bash", "-c", "~/.local/share/mango/scripts/screenshot.sh"]); 
                            }
                        }
                    }
                }
