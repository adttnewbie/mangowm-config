...
Item {
    ...
    Keys.onReturnPressed: {
        if (currentTab === 2) { 
            ...
            Quickshell.execDetached(["bash", Quickshell.env("HOME") + "/.local/share/mango/scripts/qs_manager.sh", "toggle", target]);
            event.accepted = true;
        }
    }
    ...
    SequentialAnimation {
        ...
        ScriptAction { 
            script: Quickshell.execDetached(["bash", Quickshell.env("HOME") + "/.local/share/mango/scripts/qs_manager.sh", "close"]) 
        }
    }
    ...
    RowLayout {
                            ...
                            Column {
                                ...
                                Rectangle {
                                    ...
                                    MouseArea { 
                                        ...
                                        onClicked: {
                                            if (index === 0) {
                                                Quickshell.execDetached(["bash", Quickshell.env("HOME") + "/.local/share/mango/scripts/qs_manager.sh", "toggle", "settings"]);
                                            } else {
        ...
        Item {
            ...
            Item {
                ...
                ListModel {
                    id: systemDataModel
                    ListElement { pkg: "MangoWM"; role: "Wayland Compositor"; icon: ""; clr: "blue"; link: "" }
                ...
                ColumnLayout {
                    ...
                    Rectangle {
                        ...
                        MouseArea { 
                            ...
                            hoverEnabled: true
                            cursorShape: Qt.PointingHandCursor
                            onClicked: Quickshell.execDetached(["xdg-open", "https://github.com/ilyamiro/mangowm-config"]) 
                        }
                    }
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            MouseArea { 
                                ...
                                hoverEnabled: true
                                cursorShape: Qt.PointingHandCursor
                                onClicked: Quickshell.execDetached(["bash", Quickshell.env("HOME") + "/.local/share/mango/scripts/qs_manager.sh", "toggle", modulesDataModel.get(root.selectedModuleIndex).target]) 
                            }
                        }
                    }
                    ...
                    ListView {
                        ...
                        delegate: Rectangle {
                            ...
                            MouseArea { 
                                ...
                                onDoubleClicked: { 
                                    root.selectedModuleIndex = index; 
                                    Quickshell.execDetached(["bash", Quickshell.env("HOME") + "/.local/share/mango/scripts/qs_manager.sh", "toggle", model.target]) 
                                } 
                            }
                        }
                    }
            ...
            Item {
                ...
                RowLayout {
                    ...
                    Repeater {
                        model: [
                            { name: "Mango Config", icon: "", color: "blue", url: "https://github.com/ilyamiro/mangowm-config" },
