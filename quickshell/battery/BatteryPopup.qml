                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            ...
                            onClicked: { 
                                ...
                                Quickshell.execDetached(["bash", "-c", "~/.local/share/mango/scripts/exit.sh"]); 
                    ...
                    Item {
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                Repeater {
                                    model: ListModel {
                                        ListElement { cmd: "bash ~/.local/share/mango/scripts/lock.sh"; icon: ""; baseColor: "mauve"; weight: 1.0 }
                                        ListElement { cmd: "bash ~/.local/share/mango/scripts/lock.sh & systemctl suspend"; icon: "ᶻ 𝗓 𝗓"; baseColor: "blue"; weight: 1.0 }
