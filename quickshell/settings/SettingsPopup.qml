                            ...
                            Flow {
                                ...
                                Repeater {
                                    ...
                                    Rectangle {
                                        ...
                                        MouseArea { id: wsMa; anchors.fill: parent; hoverEnabled: true; cursorShape: Qt.PointingHandCursor; onClicked: Quickshell.execDetached(["bash", Quickshell.env("HOME") + "/.local/share/mango/scripts/qs_manager.sh", wsNum.toString()]) }
                                    }
                                }
                            }
                        }
